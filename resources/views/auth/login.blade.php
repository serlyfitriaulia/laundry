...
<head>
  ...
  <section class="login-block">
                ...
                <div class="col-sm-12">
                    <form method="POST" action="{{ route('login') }}" class="md-float-material form-material">
                        ...
                        <div class="text-center">
                            <h4 class="font-weight-bold" style="color: white">Laundry Bahagia</h4>
                        </div>
    ...
    <script type="text/javascript" src="{{ asset('admin') }}/vassets/js/jquery-slimscroll/jquery.slimscroll.js "></script>
    <!-- modernizr js -->
